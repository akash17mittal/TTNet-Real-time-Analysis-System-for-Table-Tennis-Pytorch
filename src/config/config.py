...
def parse_configs():
    ...
    configs.events_weights_loss = (
        configs.events_weights_loss_dict['bounce'],
        configs.events_weights_loss_dict['net'])
    # Just "bounce" and "net hits"
    configs.num_events = len(configs.events_weights_loss_dict)
    ...
    configs.tasks_loss_weight = [loss_weight_dict[task]
    ...
    configs.logs_dir = os.path.join(
        configs.working_dir, 'logs', configs.saved_fn)
    ...
    if configs.use_best_checkpoint:
        ...
        configs.saved_weight_name = os.path.join(
            configs.checkpoints_dir, '{}.pth'.format(
                configs.saved_fn))
