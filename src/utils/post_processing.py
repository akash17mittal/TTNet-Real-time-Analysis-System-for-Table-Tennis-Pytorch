...
def post_processing(
        ...
        pred_seg,
        w,
        thresh_ball_pos_prob,
        seg_thresh,
        event_thresh):
    prediction_global = get_prediction_ball_pos(
        pred_ball_global, w, thresh_ball_pos_prob)
    prediction_local = get_prediction_ball_pos(
        pred_ball_local, w, thresh_ball_pos_prob)
