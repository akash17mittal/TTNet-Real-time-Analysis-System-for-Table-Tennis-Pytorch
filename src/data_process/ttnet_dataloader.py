...
def create_test_dataloader(configs):
    ...
    test_transform = None
    dataset_type = 'test'
    test_events_infor, test_events_labels = get_events_infor(
        configs.test_game_list, configs, dataset_type)
    test_dataset = TTNet_Dataset(
        test_events_infor,
        configs.org_size,
        configs.input_size,
...
if __name__ == '__main__':
    ...
    train_dataloader, val_dataloader, train_sampler = create_train_val_dataloader(
        configs)
    print('len train_dataloader: {}, val_dataloader: {}'.format(
